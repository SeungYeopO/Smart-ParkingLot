...
CREATE TABLE `cctv` (
  ...
  `cctv_json` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=17894 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
